...
<head>
	...
	<title>BloodLINE - Nurse Menu</title>
				...
				<div class="desktop-nav">
					<ul>
						...
						<li>
							<a href=" 
								<?php 
									if (isset($_SESSION["username"])) echo "nurseMenu.php";
								?>"
							>
								Home
			...
			<div class="container-form">
				<form name="form" action="<?= $_SERVER['PHP_SELF'] ?>" method="get">
					...
					<table id = "menu">
						...
						<tr></tr><tr>
							<td><button><a href="addDonorRec.html">Add</a></button></td>
							<td></td><td></td><td></td>
							<td><button><a href="addRecipientRec.php">Add</a></button></td>
						</tr><tr></tr>
						<!-- <tr>
