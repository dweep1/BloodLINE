  ...
  /* ==================== MANAGE BLOOD DONORS ======================== */
    ...
    include('Recipient_DonationRec_BloodSpec.control.php');
      ...
      if ($uploadOk == 0) {
       ...
       // if (empty($errors))
       // {         
              $idPic = "https://d13yacurqjgara.cloudfront.net/users/255/screenshots/683315/rogie_small.png";
            // Get values to be stored in database
            array_push($data,$trn, $fname, $lname, $addr1, $addr2, $cell, $work, $home, $email, $dob, $sex, $idpic, $mStatus, $mname);
        ...
        if(isset($_POST["save"]))  
        {
          ...
          $group = $_POST['recipient_bloodGroup'];
          $quantity = $_POST['recipient_quantityNeeded'];
          $reason = $_POST['recipient_reason'];
          $level = $_POST['recipient_urgencyLevel'];
          $location = $_POST['recipient_location'];
          $RH = $_POST['recipient_RH'];
      ...
      array_push($data,$group,$quantity,$reason,$level,$location,$RH,$compatibleWith);

      // Create control object
      $recipient = new Recipient_DonationRec_BloodSpec();
      // Add record to database
      $recipient->add_Recipient($data);

      // Confirmation message
         $msg = "Recipient. ".$data[0]." successfully added";
         echo $msg;
...
<link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=http%3A%2F%2Fwww.jotform.com%2Fform%2F61104986960865" title="oEmbed Form"><link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=http%3A%2F%2Fwww.jotform.com%2Fform%2F61104986960865" title="oEmbed Form">
<meta property="og:title" content="Official - Recipient Record" >
<meta property="og:url" content="http://www.jotform.co/form/61104986960865" >
<meta property="og:description" content="Please click the link to complete this form.">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
<meta name="HandheldFriendly" content="true" />
<!-- <title>Official - Recipient Record</title> -->
<title>Recipient Record</title>
<link href="https://cdn.jotfor.ms/static/formCss.css?3.3.12705" rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/nova.css?3.3.12705" />
<link type="text/css" media="print" rel="stylesheet" href="https://cdn.jotfor.ms/css/printForm.css?3.3.12705" />
<style type="text/css">
    .form-label-left{
...
<script src="https://cdn.jotfor.ms/file-uploader/fileuploader.js?v=3.3.12705"></script>
<script src="https://cdn.jotfor.ms/static/prototype.forms.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.12705" type="text/javascript"></script>
<script src="https://js.jotform.com/vendor/postMessage.js?3.3.12705" type="text/javascript"></script>
...
<body>
<!-- <form class="jotform-form" action="https://submit.jotform.co/submit/61104986960865/" method="post" enctype="multipart/form-data" name="form_61104986960865" id="61104986960865" accept-charset="utf-8"> -->
<form class="jotform-form" action="<?= $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data" name="form_61104986960865" id="61104986960865" accept-charset="utf-8">
  <input type="hidden" name="formID" value="61104986960865" />
  <div class="form-all">
    ...
    <ul class="form-section page-section" style="display:none;">
      <li class="form-line" data-type="control_text" id="id_75">
        <div id="cid_75" class="form-input-wide">
          <div id="text_75" class="form-html">
            <p style="text-align:center;"><strong>Recipient Record - Personal Information</strong></p>
          </div>
        </div>
      </li>
      ...
      <li class="form-line" data-type="control_fileupload" id="id_29">
        ...
        <div id="cid_29" class="form-input jf-required">
          ...
          <!-- <input class="form-upload-multiple" type="file" id="input_29" name="q29_pictureId[]" multiple="multiple" file-accept="pdf, doc, docx, xls, xlsx, csv, txt, rtf, html, zip, mp3, wma, mpg, flv, avi, jpg, jpeg, png, gif" file-maxsize="1024" file-minsize="0" file-limit="0" /> -->
          <input class="form-upload-multiple" type="file" id="input_29" name="" multiple="multiple" file-accept="jpg, jpeg, png, gif" file-maxsize="1024" file-minsize="0" file-limit="0" />
        </div>
      </li>
      <li id="cid_69" class="form-input-wide" data-type="control_pagebreak">
        <div class="form-pagebreak">
          ...
          <div class="form-pagebreak-next-container">
            <button name="next" type="submit" class="form-pagebreak-next " id="form-pagebreak-next_69">
              Next
            </button>
          </div>
        </div>
    ...
    <ul class="form-section page-section" style="display:none;">
      <li class="form-line" data-type="control_text" id="id_78">
        <div id="cid_78" class="form-input-wide">
          <div id="text_78" class="form-html">
            <p style="text-align:center;"><strong>Recipient Record - Blood Information</strong></p>
          </div>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_dropdown" id="id_89">
        <label class="form-label form-label-right form-label-auto" id="label_89" for="input_89">
          Blood Group
          <span class="form-required">
            *
          </span>
        ...
        <div id="cid_89" class="form-input jf-required">
          <!-- <select class="form-dropdown validate[required]" style="width:150px" id="input_89" name="q89_bloodGroup89"> -->
          <select class="form-dropdown validate[required]" style="width:150px" id="input_89" name="recipient_bloodGroup">
            <option value="">  </option>
      ...
      <li class="form-line jf-required" data-type="control_radio" id="id_90">
        <label class="form-label form-label-right form-label-auto" id="label_90" for="input_90">
          Blood RH
          <span class="form-required">
            *
          </span>
        ...
        <div id="cid_90" class="form-input jf-required">
          <div class="form-single-column">
            <span class="form-radio-item" style="clear:left;">
              ...
              <!-- <input type="radio" class="form-radio validate[required]" id="input_90_0" name="q90_bloodRh90" value="+" /> -->
              <input type="radio" class="form-radio validate[required]" id="input_90_0" name="recipient_RH" value="+" />
              <label id="label_input_90_0" for="input_90_0"> + </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <!-- <input type="radio" class="form-radio validate[required]" id="input_90_1" name="q90_bloodRh90" value="-" /> -->
              <input type="radio" class="form-radio validate[required]" id="input_90_1" name="recipient_RH"  value="-" />
              <label id="label_input_90_1" for="input_90_1"> - </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_82">
        ...
        <div id="cid_82" class="form-input jf-required">
          <!-- <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_82" name="q82_quantityNeeded" size="20" value="" /> -->
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_82" name="recipient_quantityNeeded" size="20" value="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_radio" id="id_91">
        <label class="form-label form-label-right form-label-auto" id="label_91" for="input_91">
          Urgency Level
          <span class="form-required">
            *
          </span>
        ...
        <div id="cid_91" class="form-input jf-required">
          <div class="form-single-column">
            <span class="form-radio-item" style="clear:left;">
              ...
              <!-- <input type="radio" class="form-radio validate[required]" id="input_91_0" name="q91_urgencyLevel" value="1 (highest)" /> -->
              <input type="radio" class="form-radio validate[required]" id="input_91_0" name="recipient_urgencyLevel" value="1" />
              <label id="label_input_91_0" for="input_91_0"> 1 (highest) </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <!-- <input type="radio" class="form-radio validate[required]" id="input_91_1" name="q91_urgencyLevel" value="2" /> -->
              <input type="radio" class="form-radio validate[required]" id="input_91_1" name="recipient_urgencyLevel" value="2" />
              <label id="label_input_91_1" for="input_91_1"> 2 </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <!-- <input type="radio" class="form-radio validate[required]" id="input_91_2" name="q91_urgencyLevel" value="3" /> -->
              <input type="radio" class="form-radio validate[required]" id="input_91_2" name="recipient_urgencyLevel" value="3" />
              <label id="label_input_91_2" for="input_91_2"> 3 </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <!-- <input type="radio" class="form-radio validate[required]" id="input_91_3" name="q91_urgencyLevel" value="4" /> -->
              <input type="radio" class="form-radio validate[required]" id="input_91_3" name="recipient_urgencyLevel" value="4" />
              <label id="label_input_91_3" for="input_91_3"> 4 </label>
            </span>
            <span class="form-radio-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <!-- <input type="radio" class="form-radio validate[required]" id="input_91_4" name="q91_urgencyLevel" value="5" /> -->
               <input type="radio" class="form-radio validate[required]" id="input_91_4" name="recipient_urgencyLevel" value="5" />
              <label id="label_input_91_4" for="input_91_4"> 5 </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line form-line-column form-col-1 jf-required" data-type="control_textarea" id="id_88">
        <label class="form-label form-label-right" id="label_88" for="input_88">
          Reason
          <span class="form-required">
            *
          </span>
        ...
        <div id="cid_88" class="form-input jf-required">
          <!-- <textarea id="input_88" class="form-textarea validate[required]" name="q88_reason" cols="40" rows="6"></textarea> -->
          <textarea id="input_88" class="form-textarea validate[required]" name="recipient_reason" cols="40" rows="6"></textarea>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_86">
        <label class="form-label form-label-right form-label-auto" id="label_86" for="input_86">
          Hospital Location
          <span class="form-required">
            *
          </span>
        ...
        <div id="cid_86" class="form-input jf-required">
          <!-- <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_86" name="q86_hospitalLocation" size="20" value="" /> -->
          <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_86" name="recipient_location" size="20" value="" />
        </div>
      </li>
...
$j(function()
{
  ...
  <input type="hidden" id="simple_spc" name="simple_spc" value="61104986960865" />
  <script type="text/javascript">
  document.getElementById("si" + "mple" + "_spc").value = "61104986960865-61104986960865";
  </script>
  <script src="https://cdn.jotfor.ms/js/widgetResizer.js?REV=3.3.12705" type="text/javascript"></script>
</form></body>
</html>
