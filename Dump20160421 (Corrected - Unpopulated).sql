...
CREATE TABLE `BloodSpecimen` (
  ...
  `bloodSpec_testResults` varchar(15) DEFAULT NULL,
  `bloodSpec_bloodType` varchar(2) DEFAULT NULL,
...
CREATE TABLE `DonationRecord` (
  ...
  `donationRec_quantityDonated` decimal(5,2) DEFAULT NULL,
...
CREATE TABLE `MedicalRecord` (
  ...
  `medicalRec_weight` decimal(5,2) DEFAULT NULL,
  `medicalRec_height` decimal(5,2) DEFAULT NULL,
  `medicalRec_bloodPressure` varchar(11) DEFAULT NULL,
  `medicalRec_temperature` decimal(5,2) DEFAULT NULL,
  `medicalRec_bloodIronLevel` decimal(5,2) DEFAULT NULL,
...
CREATE TABLE `Recipient` (
  ...
  `recipient_quantityNeeded` decimal(5,2) DEFAULT NULL,
...
-- Dump completed on 2016-04-21  2:41:12
